...
const PAYRUN_STATUSES = Object.freeze({ DRAFT: 'DRAFT', COMPUTED: 'COMPUTED', VALIDATED: 'VALIDATED', PAID: 'PAID' });
...
const schema = new mongoose.Schema({
  ...
  status: { type: String, enum: Object.values(PAYRUN_STATUSES), default: PAYRUN_STATUSES.DRAFT, required: true },
