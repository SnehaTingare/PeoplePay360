...
const createController = require('./department.controller');

module.exports = function createDepartmentRouter({ authenticate, service } = {}) {
  if (typeof authenticate !== 'function') throw new TypeError('Department routes require shared authenticate middleware.');
  const router = Router();
